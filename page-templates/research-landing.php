	...
	<section id="sidebar" class="sidebar one-of-3 column" role="navigation">
		<aside id="director_bio" class="widget interior-sidebar">
			<div class="widget-wrap director-bio-wrap">
				...
				<h2>Dr. Craig Nessler, <br />Director</h2>
				...
				<a href="http://agrilife.org/about/leadership/craignessler/"><img src="<?php bloginfo('template_directory'); ?>/images/landing/learn-nessler.png" alt="Dr. Nessler Bio" class="director-bio-btn" title="Dr. Nessler" /></a>
