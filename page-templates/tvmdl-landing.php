	...
	<section id="sidebar" class="sidebar one-of-3 column" role="navigation">
		<aside id="director_bio" class="widget interior-sidebar">
			<div class="widget-wrap director-bio-wrap">
				...
				<h2>Dr. Tammy Beckham, <br />Director</h2>
				...
				<a href="http://agrilife.org/about/leadership/tammy-beckham/"><img src="<?php bloginfo('template_directory'); ?>/images/landing/learn-beckham.png" alt="Dr. Tammy Beckham Bio" class="director-bio-btn" title="Dr. Tammy Beckham" /></a>
