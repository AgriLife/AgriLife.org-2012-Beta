	...
	<section id="sidebar" class="sidebar one-of-3 column" role="navigation">
		<aside id="director_bio" class="widget interior-sidebar">
			<div class="widget-wrap director-bio-wrap">
				...
				<a href="http://agrilifeextension.tamu.edu/"><img src="<?php bloginfo('template_directory'); ?>/images/landing/explore-extension.png" alt="Texas A&amp;M AgriLife Extension Service" class="agency-link-btn" title="Texas A&amp;M AgriLife Extension Service" /></a>
