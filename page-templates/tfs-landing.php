	...
	<section id="sidebar" class="sidebar one-of-3 column" role="navigation">
		<aside id="director_bio" class="widget interior-sidebar">
			<div class="widget-wrap director-bio-wrap">
				...
				<h2>Tom G. Boggus,<br />Director</h2>
				...
				<a href="http://agrilife.org/about/leadership/tom-boggus/"><img src="<?php bloginfo('template_directory'); ?>/images/landing/learn-boggus.png" alt="Tom G. Boggus Bio" class="director-bio-btn" title="Tom G. Boggus" /></a>
